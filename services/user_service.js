...
async function createNewMemberUser(name, email, about, languages, discord_nickname) {
  var user = await repo.createNewUser({ name: name, email: email, about: about, languages: languages, discord_nickname: discord_nickname });
